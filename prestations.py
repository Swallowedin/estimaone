        ...
        "droit_immobilier_commercial": {
            ...
            "prestations": {
                ...
                "redaction_memoire_fixation_loyer_bail_renouvele": {
                    ...
                    "tarif": 1000,
                    "definition": "Préparation d'un document argumenté pour déterminer le nouveau loyer lors du renouvellement d'un bail. Valable pour les professionnels, les personnes morales ou les particuliers se lançant dans l'entrepreneuriat"
                },
                "procedure_juge_loyers_commerciaux": {
                    "label": "Procédure devant le juge des loyers commerciaux",
                    "tarif": 3000,
                    "definition": "Représentation juridique dans un litige concernant le loyer d'un bail commercial. Valable pour les professionnels, les personnes morales ou les particuliers se lançant dans l'entrepreneuriat"
                },
        ...
        "droit_de_l'immobilier": {
            ...
            "prestations": {
                ...
                "litige_location_immobilière": {
                    ...
                    "tarif": 1500,
                    "definition": "Assistance juridique pour les conflits entre propriétaires ayant mis en location des biens immobiliers et leurs locataires : impayés de loyer, non-respect du bail, problèmes d'entretien courant, dépôt de garantie, état des lieux, charges locatives, etc. Cette prestation ne concerne que les litiges portant sur la location d'un bien immobilier et non pas les problèmes liés à l'achat ou à l'acquisition de la propriété d'un bien immobilier. Ne concerne pas non plus les location et baux portant sur des biens à usage commercial."
                },
        ...
        "compliance": {
            ...
            "prestations": {
                ...
                "conformite_concurrence": {
                    "label": "Programme de conformité au droit de la concurrence",
                    "tarif": 4500,
        ...
        "externalisation_juridique": {
            ...
            "prestations": {
                ...
                "externalisation_partielle": {  # Nouvelle option plus flexible
                    "label": "Externalisation juridique partielle",
                    "tarif": 1200,
                    "definition": "Accompagnement juridique sur des domaines spécifiques de l'entreprise, en complément des ressources internes existantes. Il s'agit d'externaliser une partie de l'équipe juridique d'une personne morale ou d'une société dans un doomaine précis : immobilier, contrats, contentieux..."
                },
